(() => {
    ...
    function initSliders() {
        if (document.querySelector(".instagram__slider")) new Swiper(".swiper", {
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (video && playPauseButton) playPauseButton.addEventListener("click", (function() {
            if (video.paused) {
                video.play();
        ...
        })); else console.error('Elements "video-prev" or "play-pause-btn" not found.');
    }));
    document.addEventListener("DOMContentLoaded", (function() {
